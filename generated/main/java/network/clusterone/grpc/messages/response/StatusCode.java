...
/**
 * Protobuf enum {@code response.StatusCode}
 */
public enum StatusCode
  ...
  NotFound(2),
  /**
   * <code>InternalServerError = 3;</code>
   */
   ...
   * <code>InternalServerError = 3;</code>
   */
  public static final int InternalServerError_VALUE = 3;
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return network.clusterone.grpc.messages.response.Response.getDescriptor().getEnumTypes().get(0);
  }
  ...
  // @@protoc_insertion_point(enum_scope:response.StatusCode)
}
